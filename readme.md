...
* **HomeWork 2/** – директория содержит файлы второго домашнего задания;
...
<br />
Начать выполнение домашнего задания №2 стоит с внимательного ознакомления с текстом задания (**HomeWork 2/Домашнее задание 2**). Если данных недостаточно, **используйте тестовые**!

[:arrow_up:Оглавление](#Оглавление)

## Контроль выполнения
Все д\з нужно выполнить до **28.04.2021, среда, 12:00**.
